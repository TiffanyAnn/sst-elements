...
grep "minPkts" ${SCRATCH}/${pct}pct_${app}_stats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_minPktsTotalStats_${i}.csv
grep "valPkts" ${SCRATCH}/${pct}pct_${app}_stats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_valPktsTotalstats_${i}.csv
grep "valBlockedPkts" ${SCRATCH}/${pct}pct_${app}_stats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_valPktsBlocked_${i}.csv
grep "minBlockedPkts" ${SCRATCH}/${pct}pct_${app}_stats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_minPktsBlocked_${i}.csv
grep "downLinksEncountered" ${SCRATCH}/${pct}pct_${app}_stats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_downLinksStats_${i}.csv
grep "totalPkts" ${SCRATCH}/${pct}pct_${app}_stats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_totalPktstats_${i}.csv

echo ${SCRATCH}/${pct}pct_${app}_${i} >> ${SCRATCH}/${pct}pct_${app}_totals.csv
echo " " >> {pct}pct_${app}_totals.csv
awk -F"," '{x+=$7}END{print "minBlocked " x}' ${SCRATCH}/${pct}pct_${app}_minPktsBlocked_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_totals.csv
awk -F"," '{x+=$7}END{print "valBlocked " x}'  ${SCRATCH}/${pct}pct_${app}_valPktsBlocked_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_totals.csv
awk -F"," '{x+=$7}END{print "minPktsTotal " x}' ${SCRATCH}/${pct}pct_${app}_minPktsTotalStats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_totals.csv
awk -F"," '{x+=$7}END{print "valPktsTotal " x}' ${SCRATCH}/${pct}pct_${app}_valPktsTotalstats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_totals.csv
awk -F"," '{x+=$7}END{print "downLinksEncountered " x}' ${SCRATCH}/${pct}pct_${app}_downLinksStats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_totals.csv
awk -F"," '{x+=$7}END{print "totalPkts " x}' ${SCRATCH}/${pct}pct_${app}_totalPktstats_${i}.csv >> ${SCRATCH}/${pct}pct_${app}_totals.csv
echo "" >> ${SCRATCH}/${pct}pct_${app}_totals.csv
